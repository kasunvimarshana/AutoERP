...
use Modules\Helpdesk\Presentation\Requests\StoreKbCategoryRequest;

class KbCategoryController extends Controller
{
    public function __construct(
        private KbCategoryRepositoryInterface $categoryRepo,
    ) {}
    ...
    public function update(StoreKbCategoryRequest $request, string $id): JsonResponse
    {
