...
class RbacSeeder extends Seeder
{
    private array $permissions = [
        ...
        'hr.departments.view', 'hr.departments.create', 'hr.departments.update',
        'hr.leave-requests.view', 'hr.leave-requests.create', 'hr.leave-requests.approve',
        'accounting.view', 'accounting.create', 'accounting.update',
        'notifications.view', 'notifications.create', 'notifications.update', 'notifications.send',
