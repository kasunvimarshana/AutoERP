...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'product_type' => 'required|string|in:inventory,service,bundle,composite',
            ...
            'cost_method' => 'required|string|in:fifo,lifo,average,standard',
            'standard_cost' => 'nullable|numeric|min:0',
            'selling_price' => 'nullable|numeric|min:0',
            'status' => 'required|string|in:draft,active,inactive,discontinued',
