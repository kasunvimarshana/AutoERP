...
class UpsertUomConversionRequest extends TenantScopedRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'from_uom_id' => array_merge($required, ['integer', 'min:1', $this->tenantExists('unit_of_measures', 'id')]),
            'to_uom_id' => array_merge($required, [
                'integer',
                'min:1',
                $this->tenantExists('unit_of_measures', 'id'),
