...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('unit_of_measures', function (Blueprint $table) {
            ...
            $table->foreignId('tenant_id')->constrained('tenants', 'id', indexName: 'unit_of_measures_tenant_fk')->restrictOnDelete()->comment('Multi-tenant owner reference');
            ...
            $table->index('tenant_id', 'unit_of_measures_tenant_ix');
            $table->index('organization_unit_id', 'unit_of_measures_org_ix');
            $table->index(['tenant_id', 'type', 'is_active'], 'unit_of_measures_type_active_ix');
            $table->index(['tenant_id', 'category', 'is_active'], 'unit_of_measures_category_active_ix');
