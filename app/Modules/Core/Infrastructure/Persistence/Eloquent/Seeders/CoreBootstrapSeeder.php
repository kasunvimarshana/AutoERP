...
namespace Modules\Core\Infrastructure\Persistence\Eloquent\Seeders;
...
final class CoreBootstrapSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::transaction(function (): void {
            ...
            $this->seedFinanceDefaults($tenantId, $organizationUnitId);
            $this->seedUomDefaults($tenantId, $organizationUnitId);
            $this->seedPaymentDefaults($tenantId, $organizationUnitId);
            $this->seedWarehouseDefaults($tenantId, $organizationUnitId);
            $this->seedItemDefaults($tenantId, $organizationUnitId);
        }, 3);
    }
    ...
    private function seedFinanceDefaults(int $tenantId, int $organizationUnitId): void
    {
        ...
        $accounts = [
            ['code' => '1000', 'name' => 'Cash on Hand', 'type' => 'ASSET', 'normal_balance' => 'DEBIT', 'is_cash_account' => true],
            ['code' => '1010', 'name' => 'Bank Account', 'type' => 'ASSET', 'normal_balance' => 'DEBIT', 'is_bank_account' => true],
            ...
            ['code' => '4000', 'name' => 'Operating Income', 'type' => 'INCOME', 'normal_balance' => 'CREDIT'],
        ...
        foreach ($accounts as $account) {
            DB::table('accounts')->updateOrInsert(
                ...
                [
                    ...
                    'currency_id' => null,
                    'depth' => 0,
                    'description' => 'Bootstrap account.',
                    'is_active' => true,
                    'is_bank_account' => (bool) ($account['is_bank_account'] ?? false),
                    'is_cash_account' => (bool) ($account['is_cash_account'] ?? false),
        ...
        $this->seedPaymentTerms($tenantId, $organizationUnitId);
        $this->seedTaxDefaults($tenantId, $organizationUnitId);
    }

    private function seedPaymentTerms(int $tenantId, int $organizationUnitId): void
    {
        ...
        $terms = [
            ['name' => 'Due on Receipt', 'due_days' => 0, 'is_default' => true],
            ['name' => 'Net 30', 'due_days' => 30, 'is_default' => false],
        ];
        ...
        foreach ($terms as $term) {
            DB::table('payment_terms')->updateOrInsert(
                ...
                [
                    'description' => 'Bootstrap payment term.',
                    'discount_days' => null,
                    'discount_rate' => null,
    ...
    private function seedTaxDefaults(int $tenantId, int $organizationUnitId): void
    {
        ...
        DB::table('tax_groups')->updateOrInsert(
            ...
            [
                'description' => 'Default zero tax group for bootstrap data.',
                'is_active' => true,
                'metadata' => $this->json(['seed_source' => 'core_bootstrap']),
                'organization_unit_id' => $organizationUnitId,
                'row_version' => 1,
        ...
        $taxGroupId = $this->requiredIdBy('tax_groups', ['tenant_id' => $tenantId, 'name' => 'Zero Rated']);
        DB::table('tax_rates')->updateOrInsert(
            ...
            [
                'account_id' => $this->idBy('accounts', ['tenant_id' => $tenantId, 'code' => '2100']),
                'is_active' => true,
                'is_compound' => false,
                'metadata' => $this->json(['seed_source' => 'core_bootstrap']),
                'organization_unit_id' => $organizationUnitId,
    ...
    private function seedUomDefaults(int $tenantId, int $organizationUnitId): void
    {
        ...
        $uoms = [
            ['name' => 'Each', 'symbol' => 'ea', 'type' => 'UNIT', 'is_base' => true],
            ['name' => 'Hour', 'symbol' => 'hr', 'type' => 'TIME', 'is_base' => true],
            ['name' => 'Day', 'symbol' => 'day', 'type' => 'TIME', 'is_base' => false],
            ['name' => 'Kilometer', 'symbol' => 'km', 'type' => 'LENGTH', 'is_base' => true],
            ['name' => 'Month', 'symbol' => 'mo', 'type' => 'TIME', 'is_base' => false],
        ];
    ...
    private function seedPaymentDefaults(int $tenantId, int $organizationUnitId): void
    {
        ...
        $methods = [
            ['code' => 'CASH', 'name' => 'Cash', 'type' => 'cash', 'account_code' => '1000'],
            ['code' => 'BANK_TRANSFER', 'name' => 'Bank Transfer', 'type' => 'bank_transfer', 'account_code' => '1010'],
        ];
        ...
        foreach ($methods as $method) {
            DB::table('payment_methods')->updateOrInsert(
                ...
                [
                    'account_id' => $this->idBy('accounts', ['tenant_id' => $tenantId, 'code' => $method['account_code']]),
                    'is_active' => true,
                    'metadata' => $this->json(['seed_source' => 'core_bootstrap']),
                    'name' => $method['name'],
                    'organization_unit_id' => $organizationUnitId,
    ...
    private function seedWarehouseDefaults(int $tenantId, int $organizationUnitId): void
    {
    ...
    private function seedItemDefaults(int $tenantId, int $organizationUnitId): void
    {
        ...
        foreach ([
            ...
            ['code' => 'SPARE_PARTS', 'name' => 'Spare Parts'],
            ...
            DB::table('item_categories')->updateOrInsert(
                ...
                [
                    'code' => $category['code'],
                    'depth' => 0,
                    'description' => 'Bootstrap item category.',
                    'image_path' => null,
                    'is_active' => true,
                    'metadata' => $this->json(['seed_source' => 'core_bootstrap']),
                    'organization_unit_id' => $organizationUnitId,
