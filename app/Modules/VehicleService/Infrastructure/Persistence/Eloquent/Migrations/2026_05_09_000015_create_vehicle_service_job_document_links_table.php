...
return new class extends Migration
{
    ...
    {
        Schema::create('vehicle_service_job_document_links', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['tenant_id', 'job_card_id', 'document_id'], 'vehicle_service_doc_links_unique');
            $table->index(['tenant_id', 'document_id'], 'vehicle_service_doc_links_doc_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('vehicle_service_job_document_links');
    }
};
