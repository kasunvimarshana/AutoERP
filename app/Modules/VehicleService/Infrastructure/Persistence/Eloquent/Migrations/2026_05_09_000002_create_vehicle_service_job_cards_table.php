...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('vehicle_service_job_cards', function (Blueprint $table) {
            ...
            $table->decimal('discount_total', 20, 4)->storedAs('line_discount_total + non_inventory_item_discount_total + labor_item_discount_total + header_discount_amount')->comment('line_discount_total + non_inventory_item_discount_total + labor_item_discount_total + header_discount_amount');
            $table->decimal('tax_total', 20, 4)->storedAs('line_tax_total + non_inventory_item_tax_total + labor_item_tax_total + header_tax_amount')->comment('line_tax_total + non_inventory_item_tax_total + labor_item_tax_total + header_tax_amount');
            ...
            $table->decimal('grand_total', 20, 4)->storedAs('subtotal + non_inventory_item_subtotal + labor_item_subtotal - line_discount_total - non_inventory_item_discount_total - labor_item_discount_total - header_discount_amount + line_tax_total + non_inventory_item_tax_total + labor_item_tax_total + header_tax_amount + debit_note_total - credit_note_total')->comment('all subtotals - discount_total + tax_total + debit_note_total - credit_note_total');

            $table->decimal('paid_amount', 20, 4)->default(0);
            $table->decimal('balance', 20, 4)->storedAs('subtotal + non_inventory_item_subtotal + labor_item_subtotal - line_discount_total - non_inventory_item_discount_total - labor_item_discount_total - header_discount_amount + line_tax_total + non_inventory_item_tax_total + labor_item_tax_total + header_tax_amount + debit_note_total - credit_note_total - paid_amount')->comment('grand_total - paid_amount');
