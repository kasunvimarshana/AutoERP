...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('service_diagnostics', function (Blueprint $table) {
            ...
            $table->string('diagnostic_phase')->default('pre');
            ...
            $table->unique(['tenant_id', 'organization_unit_id', 'diagnostic_number'], 'service_diagnostics_diagnostic_number_uk');
            $table->index(['tenant_id', 'organization_unit_id', 'job_card_id'], 'service_diagnostics_job_card_idx');
        });
    }
