...
return new class extends Migration
{
    ...
    {
        Schema::create('vehicle_service_labor_item_commission_rules', function (Blueprint $table): void {
            $table->id();
    ...
    {
        Schema::dropIfExists('vehicle_service_labor_item_commission_rules');
    }
};