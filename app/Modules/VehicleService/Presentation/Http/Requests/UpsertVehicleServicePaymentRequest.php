...
final class UpsertVehicleServicePaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'party_id' => ['required', 'integer', 'min:1', 'exists:customers,id'],
            ...
            'allocations.*.document_id' => ['required', 'integer', 'min:1', 'exists:invoices,id'],
