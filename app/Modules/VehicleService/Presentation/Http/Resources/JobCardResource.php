...
final class JobCardResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'parts_subtotal' => $this->money($this->resource->parts_subtotal),
            ...
            'gross_total' => $this->money($this->resource->subtotal),
            ...
            'charge_total' => $this->money($this->resource->header_charge_total),
            'debit_adjustment_total' => $this->money($this->resource->header_debit_adjustment_total),
            'credit_adjustment_total' => $this->money($this->resource->header_credit_adjustment_total),
            'adjustment_total' => $this->money((float) $this->resource->header_debit_adjustment_total - (float) $this->resource->header_credit_adjustment_total),
