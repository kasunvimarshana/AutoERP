...
final class SalesEngineTest extends TestCase
{
    ...
    public function test_quotation_decimal_totals_and_conversion_to_order(): void
    {
        ...
        $this->runInTenant($context, function () use ($context): void {
    ...
    public function test_payment_preparation_and_tenant_isolation(): void
    {
        ...
        $payment = app(SalesPaymentPreparationService::class)->prepareCustomerReceipt(
            ...
            '25.000000',
            customerId: $context['customer_id'],
            lines: [new PaymentLineData('25.000000')],
        );
        ...
        $this->runInTenant($context, fn () => app(SalesOrderService::class)->create(new CreateSalesOrderData(
            tenantId: $context['tenant_id'],
    ...
    {
        return $this->runInTenant($context, fn (): SalesOrder => app(SalesOrderService::class)->create(new CreateSalesOrderData(
            tenantId: $context['tenant_id'],
            salesOrderDate: '2026-06-11',
            customerId: $context['customer_id'],
            warehouseId: $context['warehouse_id'],
    ...
    {
        return $this->runInTenant($context, function () use ($context, $order, $quantity): SalesDelivery {
            $line = $order->refresh()->load('lines')->lines->first();
            $delivery = app(SalesDeliveryService::class)->create(new CreateSalesDeliveryData(
                tenantId: $context['tenant_id'],
                deliveryDate: '2026-06-11',
    ...
    {
        return $this->runInTenant($context, fn (): SalesReturn => app(SalesReturnService::class)->create(new CreateSalesReturnData(
            tenantId: $context['tenant_id'],
            returnDate: '2026-06-11',
            customerId: $context['customer_id'],
            returnType: $type,
    ...
    {
        $this->runInTenant($context, function () use ($context, $quantity, $itemId): void {
    ...
    private function runInTenant(array $context, callable $callback): mixed
    {
