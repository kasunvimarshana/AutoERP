...
final class UpsertSalesOrderLineRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'ordered_base_qty' => ['nullable', 'numeric', 'min:0'],
            ...
            'cancelled_qty' => ['nullable', 'numeric', 'min:0'],
            'outstanding_qty' => ['nullable', 'numeric', 'min:0'],
            'reservation_status' => ['sometimes', 'string', 'max:255'],
            'delivery_status' => ['sometimes', 'string', 'max:255'],
            'document_status' => ['sometimes', 'string', 'max:255'],
