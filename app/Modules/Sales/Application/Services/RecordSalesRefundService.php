...
use Modules\Sales\Application\DTOs\RecordSalesRefundData;
...
class RecordSalesRefundService extends BaseService implements RecordSalesRefundServiceInterface
{
    ...
    {
        $dto = RecordSalesRefundData::fromArray($data);
        ...
        return DB::transaction(function () use ($dto, $invoice): SalesInvoice {
            $refundPayment = $this->createPaymentService->execute([
                ...
                'payment_number' => $dto->refund_number,
                'direction' => 'outbound',
                'party_type' => 'customer',
            ...
            $this->addEvent(new SalesRefundRecorded(
