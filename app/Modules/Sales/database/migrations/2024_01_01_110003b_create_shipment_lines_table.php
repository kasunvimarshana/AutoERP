...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('shipment_lines', function (Blueprint $table) {
            ...
            $table->foreignId('shipment_id')->constrained('shipments', 'id', 'shipment_lines_shipment_id_fk')->cascadeOnDelete();
            ...
            $table->decimal('gross_amount', 20, 6)
                  ->storedAs('shipped_qty * unit_price')
            ...
            // Shipment lines account
            $table->foreignId('account_id')->nullable()->constrained('accounts', 'id', 'shipment_lines_account_id_fk')->nullOnDelete()->comment('income/asset account for posting');
