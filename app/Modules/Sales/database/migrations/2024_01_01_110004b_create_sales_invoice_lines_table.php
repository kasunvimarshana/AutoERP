...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sales_invoice_lines', function (Blueprint $table) {
            ...
            $table->foreignId('sales_invoice_id')->constrained('sales_invoices', 'id', 'sales_invoice_lines_sales_invoice_id_fk')->cascadeOnDelete();
            $table->foreignId('shipment_line_id')->nullable()->constrained('shipment_lines', 'id', 'sales_invoice_lines_shipment_line_id_fk')->nullOnDelete();
            ...
            // Sales invoice lines account
            $table->foreignId('account_id')->nullable()->constrained('accounts', 'id', 'sales_invoice_lines_account_id_fk')->nullOnDelete()->comment('income/asset account for posting');
