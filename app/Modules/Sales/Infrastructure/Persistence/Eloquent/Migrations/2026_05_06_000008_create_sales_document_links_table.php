...
return new class extends Migration
{
    ...
    {
        Schema::create('sales_document_links', function (Blueprint $table): void {
            $table->id();
            ...
            $table->string('source_type')->comment('sales_order, gdn_header, sales_return, direct_sales');
            $table->unsignedBigInteger('source_id');
            $table->unsignedBigInteger('source_line_id')->nullable();
            $table->foreignId('document_id')->constrained('documents', 'id')->cascadeOnDelete();
            $table->foreignId('document_line_id')->nullable()->constrained('document_items')->nullOnDelete();
            ...
            $table->unique(
                ...
                'sales_document_links_source_document_uk'
            );
            $table->index(['tenant_id', 'source_type', 'source_id'], 'sales_document_links_source_idx');
            $table->index(['tenant_id', 'document_id', 'status'], 'sales_document_links_document_status_idx');
        });
    }
