    ...
    public function up(): void
    {
        Schema::create('sales_invoice_links', function (Blueprint $table): void {
            ...
            $table->unique(
                ...
                'sales_invoice_links_source_invoice_uk'
            );
            $table->index(['tenant_id', 'source_type', 'source_id'], 'sales_invoice_links_source_idx');
            $table->index(['tenant_id', 'invoice_id', 'status'], 'sales_invoice_links_invoice_status_idx');
        });
    }
