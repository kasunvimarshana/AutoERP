...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('gdn_lines', function (Blueprint $table): void {
            ...
            $table->index(['tenant_id', 'gdn_header_id'], 'gdn_lines_header_idx');
            $table->index(['tenant_id', 'sales_order_line_id'], 'gdn_lines_sales_order_line_idx');
            $table->index(['tenant_id', 'item_id', 'variant_id'], 'gdn_lines_item_variant_idx');
        });
    }
