...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sales_return_lines', function (Blueprint $table): void {
            ...
            $table->index(['tenant_id', 'sales_return_id'], 'sales_return_lines_return_idx');
            $table->index(['tenant_id', 'original_gdn_line_id'], 'sales_return_lines_original_gdn_line_idx');
            $table->index(['tenant_id', 'item_id', 'variant_id'], 'sales_return_lines_item_variant_idx');
        });
    }
