...
use Modules\Sales\Infrastructure\Persistence\Eloquent\Models\SalesReturn;
...
class SalesReturnLine extends Model
{
    ...
    public function originalGdnLine(): BelongsTo
    {
        return $this->belongsTo(GdnLine::class, 'original_gdn_line_id');
    }

    public function originalSalesOrderLine(): BelongsTo
    {
        return $this->belongsTo(SalesOrderLine::class, 'original_sales_order_line_id');
    }
