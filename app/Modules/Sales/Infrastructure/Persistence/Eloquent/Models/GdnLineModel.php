...
class GdnLineModel extends Model
{
    ...
    {
        return $this->belongsTo(GdnHeaderModel::class, 'gdn_header_id');
    }
    ...
    {
        return $this->hasMany(SalesReturnLineModel::class, 'original_gdn_line_id');
    }
