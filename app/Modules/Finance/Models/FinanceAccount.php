...
final class FinanceAccount extends TenantOwnedModel
{
    ...
    protected function casts(): array
    {
        return array_merge(parent::casts(), [
            'tenant_id' => 'integer', 'organization_unit_id' => 'integer', 'account_type_id' => 'integer',
            'account_category_id' => 'integer', 'parent_id' => 'integer', 'normal_balance' => NormalBalance::class,
            'is_control_account' => 'boolean', 'is_posting_account' => 'boolean', 'is_cash_account' => 'boolean',
            'is_bank_account' => 'boolean', 'is_tax_account' => 'boolean', 'is_system' => 'boolean',
