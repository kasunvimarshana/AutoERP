...
final class FinanceLedgerEntry extends TenantOwnedModel
{
    ...
    protected function casts(): array
    {
        return array_merge(parent::casts(), [
            'tenant_id' => 'integer', 'organization_unit_id' => 'integer', 'journal_entry_id' => 'integer',
            'journal_line_id' => 'integer', 'account_id' => 'integer', 'dimension_id' => 'integer',
            'entry_date' => 'date', 'debit' => 'decimal:6', 'credit' => 'decimal:6', 'source_id' => 'integer',
            'source_date' => 'date', 'source_line_id' => 'integer',
        ]);
    }
    ...
    public function journalLine(): BelongsTo { return $this->belongsTo(FinanceJournalLine::class, 'journal_line_id'); }
    ...
    {
        self::updating(static function (): never { throw new LogicException('Ledger entries are immutable.'); });
        self::deleting(static function (): never { throw new LogicException('Ledger entries are immutable.'); });
    }
}
