...
final class UpsertJournalEntryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'total_debit' => ['nullable', 'numeric', 'gte:0'],
            'total_credit' => ['nullable', 'numeric', 'gte:0'],
            ...
            'lines.*.party_type' => ['nullable', 'string', 'max:100'],
            ...
            'lines.*.source_line_reference' => ['nullable', 'string', 'max:255'],
        ];
    }
}
