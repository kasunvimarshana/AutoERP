...
use Modules\Finance\Presentation\Http\Requests\ListApTransactionRequest;
use Modules\Finance\Presentation\Http\Requests\UpsertApTransactionRequest;
use Modules\Finance\Presentation\Http\Resources\ApTransactionResource;

final class ApTransactionController extends Controller
{
    public function __construct(
        private readonly ListApTransactionsServiceInterface $listService,
        private readonly GetApTransactionServiceInterface $getService,
    ...
    public function index(ListApTransactionRequest $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => ApTransactionResource::collection($page->items)->resolve(),
            'meta' => [
                'total' => $page->total,
                'page' => $page->page,
    ...
    public function show(int|string $id): JsonResponse|ApTransactionResource
    {
        ...
        return new ApTransactionResource($result->valueOrFail());
    }

    public function store(UpsertApTransactionRequest $request): JsonResponse|ApTransactionResource
    {
        ...
        return (new ApTransactionResource($result->valueOrFail()))->response()->setStatusCode(201);
    }

    public function update(UpsertApTransactionRequest $request, int|string $id): JsonResponse|ApTransactionResource
    {
