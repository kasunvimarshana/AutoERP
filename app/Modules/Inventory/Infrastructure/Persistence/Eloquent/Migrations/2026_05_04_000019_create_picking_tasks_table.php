...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('picking_tasks', function (Blueprint $table) {
            ...
            $table->decimal('picked_quantity', 20, 4)->default(0);
            $table->decimal('base_reserved_quantity', 20, 4)->default(0);
            $table->decimal('base_picked_quantity', 20, 4)->default(0);
            ...
            $table->index(['tenant_id', 'source_type', 'source_id'], 'picking_tasks_source_idx');
            $table->index(['tenant_id', 'item_id', 'status'], 'picking_tasks_item_status_idx');
        });
    }
