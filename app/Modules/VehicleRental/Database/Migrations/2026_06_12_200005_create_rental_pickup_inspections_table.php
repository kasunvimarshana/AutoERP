...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('rental_pickup_inspections', function (Blueprint $table): void {
            ...
            $table->unique('agreement_vehicle_id', 'rental_pickup_inspections_vehicle_uk');
            $table->index(['tenant_id', 'organization_unit_id'], 'rental_pickup_inspections_tenant_org_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('rental_pickup_inspections');
    }
};
