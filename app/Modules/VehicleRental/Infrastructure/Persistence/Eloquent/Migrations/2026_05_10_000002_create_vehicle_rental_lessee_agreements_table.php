...
return new class extends Migration
{
    ...
    {
        Schema::create('vehicle_rental_lessee_agreements', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('night_out_rate_per_hour', 20, 4)->nullable();
            ...
            $table->unique(['tenant_id', 'agreement_number'], 'vehicle_rental_lessee_agreements_agreement_number_uk');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('vehicle_rental_lessee_agreements');
    }
};
