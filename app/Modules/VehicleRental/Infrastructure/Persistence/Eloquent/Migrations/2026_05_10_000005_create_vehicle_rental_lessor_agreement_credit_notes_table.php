...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('vehicle_rental_lessor_agreement_credit_notes', function (Blueprint $table) {
            ...
            $table->foreignId('organization_unit_id')->nullable()->constrained('organization_units', 'id', 'vehicle_rental_lessor_agreement_credit_notes_ou_fk')->nullOnDelete()->comment('Branch or department ownership');
