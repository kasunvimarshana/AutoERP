...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('vehicle_rental_lessee_running_charts', function (Blueprint $table) {
            ...
            $table->foreignId('organization_unit_id')->nullable()->constrained('organization_units', 'id', 'vehicle_rental_lessee_running_charts_ou_fk')->nullOnDelete()->comment('Branch or department ownership');
