...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('vehicle_rental_lessor_running_charts', function (Blueprint $table) {
            ...
            $table->foreignId('lessor_agreement_id')->constrained('vehicle_rental_lessor_agreements', 'id')->cascadeOnDelete();
            $table->foreignId('lessee_agreement_id')->nullable()->constrained('vehicle_rental_lessee_agreements', 'id')->nullOnDelete();
