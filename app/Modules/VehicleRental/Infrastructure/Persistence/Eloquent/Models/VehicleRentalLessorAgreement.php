...
class VehicleRentalLessorAgreement extends Model
{
    ...
    {
        return $this->hasMany(
            'Modules\\VehicleRental\\Infrastructure\\Persistence\\Eloquent\\Models\\VehicleRentalLessorRunningChart',
            'lessor_agreement_id'
        );
    }
    ...
    {
        return $this->hasMany(
            'Modules\\VehicleRental\\Infrastructure\\Persistence\\Eloquent\\Models\\VehicleRentalLessorAgreementCreditNote',
            'lessor_agreement_id'
        );
    }
    ...
    {
        return $this->hasMany(
            'Modules\\VehicleRental\\Infrastructure\\Persistence\\Eloquent\\Models\\VehicleRentalLessorAgreementDebitNote',
            'lessor_agreement_id'
        );
    }
}
