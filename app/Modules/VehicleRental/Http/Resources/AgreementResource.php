...
final class AgreementResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'driver_mode' => $this->driver_mode->value,
            'supersedes_agreement' => $this->supersedesAgreement === null ? null : [
                'id' => $this->supersedesAgreement->getKey(),
                'reference' => $this->supersedesAgreement->reference,
            ],
            ...
            'agreed_on' => $this->agreed_on->toDateString(),
