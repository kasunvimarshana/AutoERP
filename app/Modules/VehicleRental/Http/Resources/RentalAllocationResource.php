...
final class RentalAllocationResource extends RentalResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'agreement' => $this->whenLoaded('agreement', fn () => $this->summary($this->agreement, ['row_version', 'agreement_number', 'agreement_kind', 'status', 'starts_at', 'ends_at'])),
            ...
            'source_allocation' => $this->whenLoaded('sourceAllocation', fn () => $this->summary($this->sourceAllocation, ['allocation_number', 'status', 'allocated_from', 'allocated_to'])),
