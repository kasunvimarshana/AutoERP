...
final class VehicleFinanceAgreementResource extends RentalResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'interest_method' => $this->enumValue($this->interest_method),
            'annual_interest_rate' => $this->decimal($this->annual_interest_rate),
            'installment_frequency' => $this->enumValue($this->installment_frequency),
            ...
            'installments' => $this->loadedCollection('installments', fn ($installment): array => [
                ...
                'principal_due' => $this->decimal($installment->principal_due),
                'interest_due' => $this->decimal($installment->interest_due),
                'fee_due' => $this->decimal($installment->fee_due),
                'tax_due' => $this->decimal($installment->tax_due),
                'total_due' => $this->decimal($installment->total_due),
                'paid_amount' => $this->decimal($installment->paid_amount),
                'balance_due' => $this->decimal($installment->balance_due),
