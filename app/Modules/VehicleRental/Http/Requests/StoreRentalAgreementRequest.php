...
class StoreRentalAgreementRequest extends TenantScopedRequest
{
    public function rules(): array
    {
        return [
            ...
            'executed_at' => ['required', 'date', 'after_or_equal:agreement_date', 'before_or_equal:now'],
            ...
            'terms.*.content' => ['required', 'string', 'max:20000'],
            ...
            'rate_version.excess_km_method' => ['nullable', Rule::enum(RentalExcessKmMethod::class)],
