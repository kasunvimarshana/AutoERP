...
final class RentalDepositLink extends TenantOwnedModel
{
    ...
    protected function casts(): array { return ['row_version'=>'integer','tenant_id'=>'integer','organization_unit_id'=>'integer','deposit_requirement_id'=>'integer','link_type'=>RentalDepositLinkType::class,'payment_id'=>'integer','invoice_id'=>'integer','amount'=>'decimal:6','status'=>RentalDepositLinkStatus::class,'linked_at'=>'datetime','reverses_link_id'=>'integer','metadata'=>'array']; }
