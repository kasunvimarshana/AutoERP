...
final class VehicleFinanceAgreement extends TenantOwnedModel
{
    ...
    protected function casts(): array { return ['row_version'=>'integer','tenant_id'=>'integer','organization_unit_id'=>'integer','supplier_id'=>'integer','vehicle_id'=>'integer','agreement_date'=>'date','starts_at'=>'datetime','matures_at'=>'datetime','currency_id'=>'integer','principal_amount'=>'decimal:6','initial_deposit_amount'=>'decimal:6','residual_value'=>'decimal:6','annual_interest_rate'=>'decimal:6','installment_count'=>'integer','payment_term_days'=>'integer','tax_group_id'=>'integer','status'=>VehicleFinanceAgreementStatus::class,'metadata'=>'array','approved_at'=>'datetime']; }
