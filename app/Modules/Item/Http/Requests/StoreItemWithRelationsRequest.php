...
final class StoreItemWithRelationsRequest extends TenantScopedRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'item.standard_price' => ['prohibited'],
            'item.default_tax_group_id' => ['nullable', 'integer', 'min:1', $this->tenantExists('tax_groups', 'id')],
            'item.purchase_tax_group_id' => ['nullable', 'integer', 'min:1', $this->tenantExists('tax_groups', 'id')],
            'item.sales_tax_group_id' => ['nullable', 'integer', 'min:1', $this->tenantExists('tax_groups', 'id')],
            ...
            'bundles.*.default_workforce_role' => ['nullable', Rule::enum(VehicleServiceWorkforceRole::class)],
            ...
            'prices.*.currency_id' => ['required', 'integer', 'min:1'],
            'prices.*.uom_id' => ['required', 'integer', 'min:1'],
