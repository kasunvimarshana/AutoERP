...
{
    use HasActiveScope, HasOrganizationUnitScope, HasReferenceScope, HasStatusScope, HasTenantScope, SoftDeletes;
    ...
    public function comboItemsAsComboItem(): HasMany
    {
        return $this->hasMany(ComboItemModel::class, 'combo_item_id');
    }

    public function comboItemsAsComponentItem(): HasMany
    {
        return $this->hasMany(ComboItemModel::class, 'component_item_id');
    }
