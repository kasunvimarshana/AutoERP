...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('payment_allocations', function (Blueprint $table) {
            ...
            $table->string('source_type')->nullable()->comment('Generic source invoice/event type for allocated target');
            ...
            $table->unique(['tenant_id', 'payment_id', 'invoice_type', 'invoice_id'], 'payment_allocations_payment_invoice_uk');
            $table->index(['tenant_id', 'invoice_type', 'invoice_id'], 'payment_allocations_invoice_idx');
