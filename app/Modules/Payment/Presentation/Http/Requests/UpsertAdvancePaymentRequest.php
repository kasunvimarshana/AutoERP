...
final class UpsertAdvancePaymentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'status' => ['nullable', 'in:open,partially_applied,fully_applied,refunded,cancelled'],
            'payment_id' => ['nullable', 'integer', 'min:1', 'exists:payments,id'],
            'notes' => ['nullable', 'string'],
            'created_by' => ['nullable', 'integer', 'min:1', 'exists:users,id'],
            'refunded_by' => ['nullable', 'integer', 'min:1', 'exists:users,id'],
            'cancelled_by' => ['nullable', 'integer', 'min:1', 'exists:users,id'],
