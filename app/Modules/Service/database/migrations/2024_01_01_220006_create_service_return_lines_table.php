...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('service_return_lines', function (Blueprint $table) {
            ...
            $table->foreignId('service_return_id')->constrained('service_returns', 'id', 'service_return_lines_service_return_id_fk')->cascadeOnDelete();
            $table->foreignId('original_service_job_card_line_id')->nullable()->constrained('service_job_card_lines', 'id', 'service_return_lines_original_service_job_card_line_id_fk')->nullOnDelete();
