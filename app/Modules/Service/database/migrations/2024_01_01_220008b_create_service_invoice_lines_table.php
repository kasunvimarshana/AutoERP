...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('service_invoice_lines', function (Blueprint $table) {
            ...
            $table->foreignId('service_invoice_id')->constrained('service_invoices', 'id', 'service_invoice_lines_service_invoice_id_fk')->cascadeOnDelete();
            $table->foreignId('service_job_card_line_id')->nullable()->constrained('service_job_card_lines', 'id', 'service_invoice_lines_service_job_card_line_id_fk')->nullOnDelete();
            ...
            // Service invoice lines account
            $table->foreignId('account_id')->nullable()->constrained('accounts', 'id', 'service_invoice_lines_account_id_fk')->nullOnDelete()->comment('account for posting');
