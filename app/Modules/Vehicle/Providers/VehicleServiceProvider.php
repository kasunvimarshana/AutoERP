...
final class VehicleServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->singleton(VehicleAvailabilityService::class,
            fn ($app): VehicleAvailabilityService => new VehicleAvailabilityService(
                $app->tagged(VehicleAvailabilityBlockerInterface::TAG),
            ),
        );
    }
