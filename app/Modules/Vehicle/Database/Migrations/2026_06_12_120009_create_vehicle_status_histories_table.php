...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('vehicle_status_histories', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('tenant_id')->constrained('tenants', indexName: 'vehicle_status_histories_tenant_fk')->restrictOnDelete();
            ...
            $table->index(['tenant_id', 'organization_unit_id'], 'vehicle_status_histories_tenant_org_ix');
            $table->index('vehicle_id', 'vehicle_status_histories_vehicle_ix');
            $table->index('new_status', 'vehicle_status_histories_status_ix');
