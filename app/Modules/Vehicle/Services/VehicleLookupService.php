...
{
    public function activeVehicles(int $tenantId, ?int $organizationUnitId = null): Collection
    {
    ...
    public function vehiclesByRegistrationNumber(int $tenantId, string $registrationNumber, ?int $organizationUnitId = null): Collection
    {
        return $this->baseQuery($tenantId, $organizationUnitId)->where('registration_number', $registrationNumber)->get();
    }

    public function vehiclesAvailableForService(int $tenantId, ?int $organizationUnitId = null): Collection
    {
    ...
    public function vehiclesByType(int $tenantId, int $typeId, ?int $organizationUnitId = null): Collection
    {
        return $this->baseQuery($tenantId, $organizationUnitId)->where('vehicle_type_id', $typeId)->get();
    }

    public function vehiclesByCategory(int $tenantId, int $categoryId, ?int $organizationUnitId = null): Collection
    {
        return $this->baseQuery($tenantId, $organizationUnitId)->where('vehicle_category_id', $categoryId)->get();
    }
