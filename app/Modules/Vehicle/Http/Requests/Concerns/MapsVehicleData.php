...
trait MapsVehicleData
{
    private function mapVehicleData(array $vehicle, array $relations = []): CreateVehicleData
    {
        return new CreateVehicleData(
            ...
            customerId: $this->nullableInt($vehicle, 'customer_id'),
            currentOwnerType: $this->nullableString($vehicle, 'current_owner_type'),
            currentOwnerId: $this->nullableInt($vehicle, 'current_owner_id'),
