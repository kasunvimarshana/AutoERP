...
final class VehicleController
{
    ...
    public function changeStatus(ChangeVehicleStatusRequest $request, int $vehicle): VehicleResource
    {
        ...
        return new VehicleResource($this->statuses->change($model, $request->toData())->load(['make', 'model', 'type', 'category', 'currentOwnerships', 'currentOwnerships']));
    }
    ...
    private function changeTo(ListVehicleRequest $request, int $vehicle, VehicleStatus $status): VehicleResource
    {
        ...
        )->load(['make', 'model', 'type', 'category', 'currentOwnerships', 'currentOwnerships']));
    }
