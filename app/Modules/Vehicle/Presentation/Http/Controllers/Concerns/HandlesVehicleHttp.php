...
namespace Modules\Vehicle\Presentation\Http\Controllers\Concerns;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Modules\Vehicle\Domain\Exceptions\VehicleRecordNotFoundException;

trait HandlesVehicleHttp
{
    /**
    ...
    protected function notFound(VehicleRecordNotFoundException $exception): JsonResponse
    {
