...
use Modules\User\Services\Authentication\AuthenticationDirectory;
...
final class UserServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->scoped(AuthenticationDirectory::class);
        $this->app->scoped(AuthenticationPrincipalProviderInterface::class, AuthenticationDirectory::class);
        $this->app->scoped(TenantUserAuthenticationDirectoryInterface::class, AuthenticationDirectory::class);
        $this->app->scoped(PlatformOperatorAuthenticationDirectoryInterface::class, AuthenticationDirectory::class);
