...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('user_roles', function (Blueprint $table): void {
            ...
            $table->foreignId('tenant_id')->constrained('tenants', 'id', indexName: 'user_roles_tenant_fk')->restrictOnDelete();
            ...
            $table->foreign(['created_by_user_id', 'tenant_id'], 'user_roles_created_by_user_tenant_fk')
                ->references(['id', 'tenant_id'])->on('users')->restrictOnDelete();
            $table->foreign(['updated_by_user_id', 'tenant_id'], 'user_roles_updated_by_user_tenant_fk')
                ->references(['id', 'tenant_id'])->on('users')->restrictOnDelete();
        });
    }
