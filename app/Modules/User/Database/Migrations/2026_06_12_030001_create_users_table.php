...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->foreignId('tenant_id')->nullable()->constrained('tenants', 'id')->restrictOnDelete()->comment('Multi-tenant owner reference');
            ...
            $table->rememberToken();
            $table->string('status')->default('active')->comment('invited, active, inactive, suspended');
