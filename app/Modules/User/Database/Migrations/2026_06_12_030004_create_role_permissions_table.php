...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('role_permissions', function (Blueprint $table): void {
            ...
            $table->foreign(['created_by_user_id', 'tenant_id'], 'role_permissions_created_by_user_tenant_fk')
                ->references(['id', 'tenant_id'])->on('users')->restrictOnDelete();
            $table->foreign(['updated_by_user_id', 'tenant_id'], 'role_permissions_updated_by_user_tenant_fk')
                ->references(['id', 'tenant_id'])->on('users')->restrictOnDelete();
        });
    }
