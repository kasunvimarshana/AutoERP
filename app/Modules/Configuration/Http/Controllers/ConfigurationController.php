...
final class ConfigurationController extends Controller
{
    ...
    public function definitions(ViewConfigurationRequest $request): JsonResponse
    {
        return response()->json([
            'data' => ConfigurationDefinitionResource::collection(
    ...
    public function show(
        ViewConfigurationRequest $request,
        string $key,
    ): ConfigurationEntryResource {
        return new ConfigurationEntryResource(
            $this->entries->exact($this->scope($request), $key),
        );
    }

    public function history(
        ListConfigurationEntriesRequest $request,
        string $key,
    ): JsonResponse {
    ...
    public function destroy(
        DeleteConfigurationEntryRequest $request,
        string $key,
    ): JsonResponse {
        $validated = $request->validated();
        $this->entries->delete(
