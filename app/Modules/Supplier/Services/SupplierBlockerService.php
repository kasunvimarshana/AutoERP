...
final class SupplierBlockerService
{
    ...
    {
        foreach (['purchase_orders', 'goods_receipt_notes', 'purchase_returns', 'purchase_debit_notes', 'supplier_vehicles', 'supplier_tax_profiles', 'rental_agreements', 'vehicle_finance_agreements', 'rental_expenses', 'rental_usage_contexts', 'rental_expense_allocations'] as $table) {
