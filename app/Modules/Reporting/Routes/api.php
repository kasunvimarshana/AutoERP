...
Route::prefix('api/v1/reports')->middleware($middleware)->name('api.v1.reports.')->group(function () use ($requires): void {
    ...
    Route::middleware($requires(ReportingAuthorizationService::REPORTS_EXPORT))->group(function (): void {
