    ...
    public function register(): void
    {
        ...
        foreach (
            [
                ...
                PreviewSequenceNumberServiceInterface::class => PreviewSequenceNumberService::class,
                GenerateSequenceNumberServiceInterface::class => GenerateSequenceNumberService::class,
                RollbackSequenceNumberServiceInterface::class => RollbackSequenceNumberService::class,
