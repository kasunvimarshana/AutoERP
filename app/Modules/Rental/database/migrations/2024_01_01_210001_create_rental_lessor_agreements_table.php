...
return new class extends Migration
{
    ...
    {
        Schema::create('rental_lessor_agreements', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('rental_expense_account_id')->nullable()->constrained('accounts', 'id')->nullOnDelete();
            $table->foreignId('excess_km_expense_account_id')->nullable()->constrained('accounts', 'id')->nullOnDelete();
            ...
            $table->unique(['tenant_id', 'org_unit_id', 'agreement_number'], 'lessor_agreements_number_uk');
            $table->index(['tenant_id', 'lessor_id'], 'lessor_agreements_lessor_idx');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('rental_lessor_agreements');
    }
};
