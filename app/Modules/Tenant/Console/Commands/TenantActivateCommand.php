...
{
    protected $signature='tenant:activate {tenant : Tenant identifier} {expected-version : Current row version} {--reason= : Required lifecycle reason}';
    protected $description='Activate a tenant through the validated lifecycle';
    public function __construct(private readonly ActivateTenantService $service){parent::__construct();}
    public function handle():int
    {
        ...
        $this->info('Tenant activated.');return self::SUCCESS;
    }
}
