...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tenants', function (Blueprint $table): void {
            ...
            $table->foreignId('tenant_plan_id')->nullable()->constrained('tenant_plans', 'id')->restrictOnDelete();
            ...
            $table->timestamps();
            $table->index(['status', 'subscription_ends_at'], 'tenants_status_subscription_idx');
        });
    }
