...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('tenant_domains', function (Blueprint $table): void {
            ...
            $table->string('ownership_status', 40)->default('pending');
            $table->string('routing_status', 40)->default('pending');
            $table->string('tls_status', 40)->default('pending');
            $table->string('reachability_status', 40)->default('pending');
            $table->string('operational_status', 40)->default('pending');
            $table->string('verification_method', 40)->default('dns_txt');
