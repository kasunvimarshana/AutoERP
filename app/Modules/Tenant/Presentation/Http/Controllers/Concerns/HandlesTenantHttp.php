...
namespace Modules\Tenant\Presentation\Http\Controllers\Concerns;

use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Modules\Tenant\Domain\Exceptions\TenantRecordNotFoundException;

trait HandlesTenantHttp
{
    /**
    ...
    protected function notFound(TenantRecordNotFoundException $exception): JsonResponse
    {
