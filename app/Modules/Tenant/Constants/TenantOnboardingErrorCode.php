...
final class TenantOnboardingErrorCode
{
    ...
    public const ADMINISTRATOR_ACCOUNT_FAILED = 'TENANT_ADMINISTRATOR_ACCOUNT_FAILED';
    ...
    public static function forStep(string $step): string
    {
        return match ($step) {
            ...
            TenantOnboardingStep::INITIAL_ADMIN_ACCOUNT => self::ADMINISTRATOR_ACCOUNT_FAILED,
    ...
    public static function safeMessage(string $step): string
    {
        return match ($step) {
            ...
            TenantOnboardingStep::INITIAL_ADMIN_ACCOUNT => 'The initial administrator account could not be created.',
