...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('product_identifiers', function (Blueprint $table) {
            ...
            $table->index(['tenant_id', 'organization_unit_id', 'product_id', 'variant_id'], 'product_identifiers_product_variant_idx');
            $table->index(['tenant_id', 'organization_unit_id', 'value'], 'product_identifiers_value_idx');
            $table->index(['tenant_id', 'organization_unit_id', 'is_active', 'value'], 'product_identifiers_active_value_idx');
        });
    }
