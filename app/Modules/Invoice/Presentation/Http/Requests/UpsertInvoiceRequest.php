...
final class UpsertInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'invoice_type' => array_merge($required, ['string', 'max:255']),
            'invoice_number' => array_merge($required, ['string', 'max:255']),
            'reference' => ['nullable', 'string', 'max:255'],
            'status' => ['nullable', 'string', 'max:255'],
            'party_type' => ['nullable', 'string', 'max:255'],
            'party_id' => ['nullable', 'integer', 'min:1'],
            'invoice_date' => array_merge($required, ['date']),
            'due_date' => array_merge($required, ['date']),
