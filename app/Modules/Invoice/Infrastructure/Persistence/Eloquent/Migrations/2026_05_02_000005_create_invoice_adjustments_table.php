...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('invoice_adjustments', function (Blueprint $table): void {
            ...
            // tax, discount, charge, withholding, rounding, debit_adjustment, credit_adjustment, write_off
            ...
            // Amount is a non-negative magnitude. The effect column defines the direction.
