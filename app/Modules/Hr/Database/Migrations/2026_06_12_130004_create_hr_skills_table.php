...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('hr_skills', function (Blueprint $table): void {
            $table->id();
            $table->foreignId('tenant_id')->constrained('tenants', indexName: 'hr_skills_tenant_fk')->restrictOnDelete();
            ...
            $table->index(['tenant_id', 'organization_unit_id'], 'hr_skills_tenant_org_ix');
