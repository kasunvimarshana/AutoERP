...
final class EmployeeRelationRequest extends TenantScopedRequest
{
    ...
    public function rules(): array
    {
        ...
        return $base + match ((string) $this->route()->getName()) {
            ...
            'api.v1.hr.documents.store', 'api.v1.hr.documents.update' => ['document_type' => ['required', Rule::enum(EmployeeDocumentType::class)], 'document_number' => ['nullable', 'string'], 'issued_date' => ['nullable', 'date'], 'expiry_date' => ['nullable', 'date'], 'file_path' => ['nullable', 'string'], 'status' => ['nullable', Rule::enum(EmployeeDocumentStatus::class)], 'notes' => ['nullable', 'string']],
