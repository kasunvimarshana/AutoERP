...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('hr_leave_applications', function (Blueprint $table) {
            ...
            $table->index(['tenant_id', 'organization_unit_id', 'employee_id', 'status'], 'hr_leave_applications_employee_status_idx');
            $table->index(['tenant_id', 'organization_unit_id', 'status', 'start_date'], 'hr_leave_applications_status_date_idx');
        });
    }
