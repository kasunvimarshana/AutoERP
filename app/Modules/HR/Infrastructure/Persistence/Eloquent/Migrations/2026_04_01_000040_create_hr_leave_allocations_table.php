...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('hr_leave_allocations', function (Blueprint $table) {
            ...
            $table->unique(['tenant_id', 'organization_unit_id', 'employee_id', 'leave_type_id', 'year'], 'hr_leave_allocations_employee_type_year_uk');
            $table->index(['tenant_id', 'organization_unit_id', 'employee_id', 'year'], 'hr_leave_allocations_employee_year_idx');
        });
    }
