...
return new class extends Migration
{
    ...
    {
        Schema::create('hr_leave_policy_lines', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('accrual_amount', 5, 2)->default(0);
            $table->decimal('carry_forward_max', 5, 2)->default(0);

            $table->timestamps();

            $table->unique(['tenant_id', 'organization_unit_id', 'leave_policy_id', 'leave_type_id'], 'hr_leave_policy_lines_policy_type_uk');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('hr_leave_policy_lines');
    }
};
