...
class EloquentEmployeeContactRepository extends EloquentRepository implements EmployeeContactRepositoryInterface
{
    ...
    public function findByEmail(string $email, array $with = []): ?Model
    {
        return $this->query($with)->where('email', $email)->first();
    }
