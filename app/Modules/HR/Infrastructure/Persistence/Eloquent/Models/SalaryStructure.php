...
class SalaryStructure extends Model
{
    ...
    {
        return $this->hasMany('Modules\\HR\\Infrastructure\\Persistence\\Eloquent\\Models\\SalaryStructureLine', 'salary_structure_id');
    }

    public function assignments(): HasMany
    {
        return $this->hasMany('Modules\\HR\\Infrastructure\\Persistence\\Eloquent\\Models\\EmployeeSalaryAssignment', 'salary_structure_id');
    }

    public function payslips(): HasMany
    {
        return $this->hasMany('Modules\\HR\\Infrastructure\\Persistence\\Eloquent\\Models\\Payslip', 'salary_structure_id');
    }
}
