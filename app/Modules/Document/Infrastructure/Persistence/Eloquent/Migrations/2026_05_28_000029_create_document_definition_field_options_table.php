...
return new class extends Migration
{
    ...
    {
        Schema::create('document_definition_field_options', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(
                ...
                'document_definition_field_options_unique'
            );
            $table->index(
                ['tenant_id', 'field_definition_id', 'display_order'],
                'document_definition_field_options_order_index'
            );
        });
    }
    ...
    {
        Schema::dropIfExists('document_definition_field_options');
    }
};
