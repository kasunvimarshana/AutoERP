...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('comments', function (Blueprint $table) {
            ...
            $table->foreignId('tenant_id')->constrained('tenants', 'id', indexName: 'comments_tenant_fk')->restrictOnDelete()->comment('Multi-tenant owner reference');
            ...
            $table->index(['tenant_id', 'commentable_type', 'commentable_id'], 'comments_type_id_ix');
            $table->index(['tenant_id', 'source_module', 'source_type', 'source_id'], 'comments_source_ix');
