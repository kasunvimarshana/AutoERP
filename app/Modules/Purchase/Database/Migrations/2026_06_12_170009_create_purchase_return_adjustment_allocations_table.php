...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (in_array(DB::getDriverName(), ['mysql', 'pgsql'], true)) {
            DB::statement('ALTER TABLE purchase_return_adjustment_allocations ADD CONSTRAINT purchase_return_adjustment_allocations_amounts_chk CHECK (source_amount >= 0 AND previously_returned_amount >= 0 AND returned_amount >= 0 AND remaining_amount >= 0)');
        }
    }
