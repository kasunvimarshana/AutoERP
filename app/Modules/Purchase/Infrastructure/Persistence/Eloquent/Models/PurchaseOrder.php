...
class PurchaseOrder extends Model
{
    ...
    {
        $query->whereIn('status', [PurchaseOrderStatus::Draft, PurchaseOrderStatus::Confirmed]);
    }
    ...
    {
        return $this->hasMany(
            'Modules\\Purchase\\Infrastructure\\Persistence\\Eloquent\\Models\\PurchaseOrderLine',
            'purchase_order_id'
        );
    }
    ...
    {
        return $this->hasMany(
            'Modules\\Purchase\\Infrastructure\\Persistence\\Eloquent\\Models\\GrnHeader',
            'purchase_order_id'
        );
    }
}
