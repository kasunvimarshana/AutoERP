...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('purchase_return_lines', function (Blueprint $table): void {
            ...
            $table->foreignId('original_grn_line_id')->nullable()->constrained('grn_lines', 'id')->cascadeOnDelete();
            $table->foreignId('original_purchase_order_line_id')->nullable()->constrained('purchase_order_lines', 'id')->cascadeOnDelete();
