...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('purchase_orders', function (Blueprint $table): void {
            ...
            $table->foreignId('warehouse_id')->constrained('warehouses', 'id')->cascadeOnDelete();
            $table->string('po_number');
            $table->string('status')->default('draft')->comment('draft, confirmed, partially_received, received, cancelled');
            ...
            $table->foreignId('price_list_id')->nullable()->constrained('price_lists', 'id')->cascadeOnDelete();
            ...
            $table->unique(['tenant_id', 'po_number'], 'purchase_orders_po_number_uk');
        });
    }
