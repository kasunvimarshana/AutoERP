...
final class UpsertGrnLineRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'grn_header_id' => array_merge($required, ['integer', 'min:1', 'exists:grn_headers,id']),
            ...
            'expected_qty' => ['nullable', 'numeric'],
            'received_qty' => array_merge($required, ['numeric']),
            'accepted_qty' => ['nullable', 'numeric'],
            'rejected_qty' => ['nullable', 'numeric'],
            'damaged_qty' => ['nullable', 'numeric'],
            'inspected_qty' => ['nullable', 'numeric'],
            'putaway_qty' => ['nullable', 'numeric'],
            'returned_qty' => ['nullable', 'numeric'],
            'documented_qty' => ['nullable', 'numeric'],
