...
class StorePurchaseOrderRequest extends PurchaseRequest
{
    public function rules(): array
    {
        return array_merge($this->scopeRules(), [
            ...
            'adjustments.*.finance_posting_profile_id' => ['prohibited'],
            'adjustments.*.finance_account_id' => ['prohibited'],
            'adjustments.*.cost_treatment' => ['prohibited'],
            'adjustments.*.tax_treatment' => ['prohibited'],
            'adjustments.*.mapping_source' => ['prohibited'],
            'adjustments.*.override_reason' => ['prohibited'],
        ]);
    }
