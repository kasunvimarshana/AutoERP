...
Route::prefix('api/v1/purchase')->middleware($middleware)->name('api.v1.purchase.')->group(function (): void {
    ...
    Route::get('orders/{order}/receivable-lines', [PurchaseOrderController::class, 'receivableLines'])->whereNumber('order')->name('orders.receivable-lines');
    Route::get('orders/{order}/invoiceable-lines', [PurchaseOrderController::class, 'invoiceableLines'])->whereNumber('order')->name('orders.invoiceable-lines');
    ...
    Route::get('goods-receipts/{grn}/returnable-lines', [GoodsReceiptNoteController::class, 'returnableLines'])->whereNumber('grn')->name('goods-receipts.returnable-lines');
