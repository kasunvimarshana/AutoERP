...
abstract class CustomerAddressRequest extends TenantScopedRequest
{
    public function rules(): array
    {
        return [
            ...
            'address_type' => ['required', Rule::enum(CustomerAddressType::class)],
    ...
    public function toData(): CustomerAddressData
    {
        return new CustomerAddressData(
            addressType: CustomerAddressType::from((string) $this->input('address_type')),
