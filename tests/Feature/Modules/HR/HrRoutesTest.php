...
final class HrRoutesTest extends TestCase
{
    public function testHrRoutesAreRegistered(): void
    {
        ...
        self::assertTrue(Route::has('hr.employee-contacts.index'));
        self::assertTrue(Route::has('hr.employee-contacts.store'));
        self::assertTrue(Route::has('hr.employee-contacts.show'));
        self::assertTrue(Route::has('hr.employee-contacts.update'));
        self::assertTrue(Route::has('hr.employee-contacts.destroy'));
