...
final class PlatformOperatorInvitationResendLifecycleTest extends TestCase
{
    ...
    public function test_resend_preserves_the_active_token_and_queues_a_new_attempt(): void
    {
        Queue::fake();
        ...
        $service = new PlatformOperatorInvitationService(
            ...
            $this->app->make(PlatformOperatorInvitationTokenCodec::class),
        ...
        $operator = $executionContext->runAsControlPlane(
