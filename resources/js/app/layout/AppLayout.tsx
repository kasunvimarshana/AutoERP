...
const navigationSections: Array<{ title: string; items: NavigationItem[] }> = [
    ...
    },
    {
        ...
        items: [
            ...
            { to: '/finance/posting-profiles', label: 'Posting profiles' },
            { to: '/finance/fiscal-periods', label: 'Fiscal periods' },
            { to: '/finance/reversals', label: 'Reversals' },
            ...
            { to: '/finance/bank-reconciliations', label: 'Bank reconciliation' },
