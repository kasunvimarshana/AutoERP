        ...
        items: [
            {
                ...
                children: [
                    ...
                    {
                        id: 'supplier-create', type: 'link', label: 'Create Supplier', to: '/suppliers/create', match: ['/suppliers/create'], access: { ...tenantAccess(['supplier']), permissions: ['suppliers.create'] },
                    },
                    {
                        ...
                        access: { ...tenantAccess(['vehicle', 'supplier']), permissions: ['supplier-vehicles.view'] },
                    },
                    {
                        id: 'supplier-vehicle-create', type: 'link', label: 'Create Supplier Vehicle', to: '/supplier-vehicles/create', match: ['/supplier-vehicles/create'], access: { ...tenantAccess(['vehicle','supplier']), permissions: ['supplier-vehicles.create'] },
                    },
                ],
            },
            {
                ...
                children: [
                    ...
                    {
                        id: 'customer-create', type: 'link', label: 'Create Customer', to: '/customers/create', match: ['/customers/create'], access: { ...tenantAccess(['customer']), permissions: ['customers.create'] },
                    },
                    {
                        ...
                        access: { ...tenantAccess(['vehicle', 'customer']), permissions: ['customer-vehicles.view'] },
                    },
                    {
                        id: 'customer-vehicle-create', type: 'link', label: 'Create Customer Vehicle', to: '/customer-vehicles/create', match: ['/customer-vehicles/create'], access: { ...tenantAccess(['vehicle','customer']), permissions: ['customer-vehicles.create'] },
                    },
                ],
            },
            {
