        ...
        items: [
            ...
            },
            {
                ...
                children: [
                    ...
                    { id: 'lessee-running-charts', type: 'link', label: 'Lessee Running Charts - Customer', to: '/vehicle-rental/running-chart?mode=lessee', match: ['/vehicle-rental/running-chart'], access: operationalAccess(['vehicle-rental']) },
                    { id: 'lessor-running-charts', type: 'link', label: 'Lessor Running Charts - Owner / Supplier', to: '/vehicle-rental/running-chart?mode=lessor', match: ['/vehicle-rental/running-chart'], access: operationalAccess(['vehicle-rental']) },
                    { id: 'linked-running-charts', type: 'link', label: 'Linked Running Charts - Customer + Owner', to: '/vehicle-rental/running-chart?mode=linked', match: ['/vehicle-rental/running-chart'], access: operationalAccess(['vehicle-rental']) },
