...
export async function getTenantReadiness(id: number, signal?: AbortSignal): Promise<TenantReadiness> {
    const response = await apiClient.get<ApiResource<TenantReadiness>>(
