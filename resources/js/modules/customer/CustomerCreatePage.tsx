...
export default function CustomerCreatePage() {
    ...
    return (
        <>
            <ContentHeader
                title="New customer"
                description="Customers start pending approval. Activation is a separate authorized lifecycle command."
            />
                ...
                {includeRelated ? (
                    <>
                        <TabPanel tabsId="customer-create" tabId="basic" active={activeTab}>
                            <CustomerForm value={customer} onChange={setCustomer} currency={currency} onCurrencyChange={setCurrency} error={error} />
                        </TabPanel>
                        {relatedTabs.map((tab) => (
