...
export function CustomerSummaryCard({ customer }: { customer: Customer }) {
    return <DetailGrid items={[
        ...
        { label: 'Credit limit', value: <MoneyDisplay value={customer.credit_profile?.credit_limit ?? '0.000000'} /> },
        { label: 'Credit allowed', value: customer.credit_allowed ? 'Yes' : 'No' },
        { label: 'Advance allowed', value: customer.advance_allowed ? 'Yes' : 'No' },
