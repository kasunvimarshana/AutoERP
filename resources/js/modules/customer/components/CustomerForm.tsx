...
import { customerTypes, preferredCommunicationChannels, type CustomerPayload } from '../customerTypes';
import { CustomerCurrencySelect } from './CustomerCurrencySelect';

export function CustomerForm({ value, onChange, currency, onCurrencyChange, error }: {
    ...
    return <div className="space-y-5">
        ...
        <Panel title="Contact and commercial defaults">
            ...
            <p className="mt-3 text-sm text-slate-500">Opening balances are recorded through governed Finance opening journals.</p>
