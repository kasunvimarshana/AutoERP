    ...
    return (
        <div className="space-y-5">
            ...
            <div className="grid gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4 md:grid-cols-[minmax(0,1fr)_auto]">
                <GenericLookupSelect label="Issue warehouse" value={warehouse} onChange={(value) => { setWarehouse(value); setSelected([]); }} search={search} formatLabel={(value) => `${value.code ?? ''} ${value.name}`.trim()} />
