...
export default function LedgerReportPage() {
    ...
    return <>
        <ContentHeader title="General ledger" description="Posted ledger entries with account, period, journal, and source traceability." actions={<Link className="text-sm font-semibold text-sky-700 hover:underline" to="/reports/finance.ledger">Export report</Link>} />
