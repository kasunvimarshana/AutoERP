...
export function UomUnitListPage() {
    ...
    return (
        <div className="space-y-6">
            <PageHeader actions={<Link to="/uom/units/new"><Button>New Unit</Button></Link>} eyebrow="UOM" subtitle="Units support receipt, issue, consumption, charge, and inventory contexts without frontend conversion calculations." title="Units" />
