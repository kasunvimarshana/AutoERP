            ...
            <form onSubmit={submit}>
                <FormSection description="Provide a journal entry id for authoritative backend preview. Source fields are carried as context only." title="Preview Context">
                    <div className="grid gap-4 md:grid-cols-4">
                        ...
                        <label className="space-y-2 text-sm"><span className="font-semibold text-slate-700">Source module</span><Select name="sourceModule"><option value="">Manual Journal</option><option value="payment">Payment</option><option value="inventory">Inventory</option><option value="invoice">Invoice</option></Select></label>
                        <label className="space-y-2 text-sm"><span className="font-semibold text-slate-700">Source type</span><Input name="sourceType" placeholder="payment, movement, invoice..." /></label>
