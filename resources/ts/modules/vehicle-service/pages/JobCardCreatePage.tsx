    ...
    return (
        <div className="space-y-6">
            <VehicleServicePageHeader
                actions={<><Link to="/vehicle-service/job-cards"><Button variant="secondary">Cancel</Button></Link><Button>Save Draft</Button><Button variant="blue">Submit Backend Preview</Button></>}
                ...
                title="New Job Card"
            />
            <JobCardForm jobCard={getJobCardById('job-001')} />
        </div>
    );
}
