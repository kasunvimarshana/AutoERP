...
export function PurchaseOrderDetailPage() {
    ...
    async function invoice() { if (!order) return; setBusy(true); try { await purchaseApi.invoiceOrder(order.id); setOrder(await purchaseApi.getOrder(order.id)); } catch (requestError) { setError(requestError instanceof Error ? requestError.message : 'Unable to create purchase invoice.'); } finally { setBusy(false); } }
