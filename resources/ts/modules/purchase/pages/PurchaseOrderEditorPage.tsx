...
const blankLine: PurchaseLineInput = { itemId: 0, orderedQty: '1', taxAmount: '0', unitPrice: '0', uomId: 0 };
...
export function purchasePreview(value: { lines: PurchaseLineInput[] } & PurchaseHeaderTotalsInput) {
    const lineTotals = value.lines.reduce((totals, line) => {
        const quantity = numeric(line.orderedQty ?? line.receivedQty ?? line.returnQty);
