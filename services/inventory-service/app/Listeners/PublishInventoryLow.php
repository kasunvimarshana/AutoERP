...
class PublishInventoryLow implements ShouldQueue
{
    ...
    {
        $this->publish('inventory.low', $event->broadcastWith());
    }

    public function failed(InventoryLow $event, Throwable $exception): void
    {
        Log::error('Failed to publish InventoryLow event to RabbitMQ', [
