...
abstract class BaseRepository implements BaseRepositoryInterface
{
    ...
    /**
     * Full-text search across multiple columns using LIKE.
     */
     ...
     * Dot-notation operator suffix supported, e.g. 'total:gte' => 100.
     */
    ...
    /**
     * Perform an authenticated HTTP GET to another microservice.
     */
    public function crossServiceFetch(string $serviceUrl, string $endpoint, array $params = []): mixed
    {
        ...
        try {
            ...
            Log::warning('BaseRepository::crossServiceFetch non-success', [
                'url'    => $url,
            ...
            Log::error('BaseRepository::crossServiceFetch error', [
                'url'   => $url,
                'error' => $e->getMessage(),
            ]);
