...
class MovingAverageValuationStrategy implements ValuationStrategyContract
{
    public function resolveOutboundUnitCost(MovementLineDTO $line, AllocationResultDTO $allocation): float
    {
        return round((float) ($line->metadata['moving_average_unit_cost'] ?? $allocation->weightedUnitCost()), 4);
    }
