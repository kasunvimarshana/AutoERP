...
final class AggregateRootGenerator extends AbstractGenerator
{
    public function stubKey(): string { return 'domain/aggregate'; }
    public function label(): string   { return 'Aggregate Root'; }
    ...
    protected function targetPath(string $context, string $className): string
    {
        return $this->buildPath($context,
            ...
            config('ddd-architect.domain_directories.aggregates'),
            "{$className}.php");
    }
