...
class DDDInfoCommand extends BaseCommand
{
    ...
    public function handle(): int
    {
        ...
        $this->table(['Command', 'Description'], [
            ...
            ['<fg=cyan>ddd:make-model {ctx} {name}</>',        'Create Eloquent Model + Factory + Seeder'],
            ['<fg=cyan>ddd:make-listener {ctx} {name}</>',     'Create an Infrastructure Event Listener'],
            ['<fg=cyan>ddd:make-policy {ctx} {name}</>',       'Create a Domain Policy'],
